...
const char * arg01;
const char * arg02;
Qt::ConnectionType arg03 = Qt::AutoConnection;
const QObject * arg10;
const char * arg11;
const char * arg12;
Qt::ConnectionType arg13;
const QObject * arg20;
const char * arg21;
const QObject * arg22;
const char * arg23;
Qt::ConnectionType arg24 = Qt::AutoConnection;
const QObject * arg30;
const char * arg31;
const QObject * arg32;
const char * arg33;
Qt::ConnectionType arg34;
PPCODE:
    switch(items) {
    case 4:
      {
    ...
    switch(SvIV(ST(4))) {
    case 0:
      arg13 = Qt::AutoConnection;
      break;
    case 1:
      arg13 = Qt::DirectConnection;
      break;
    case 2:
      arg13 = Qt::QueuedConnection;
      break;
    case 3:
      arg13 = Qt::AutoCompatConnection;
      break;
    case 4:
      arg13 = Qt::BlockingQueuedConnection;
      break;
    case 5:
      arg13 = Qt::UniqueConnection;
      break;
    default:
    ...
    switch(SvIV(ST(5))) {
    case 0:
      arg34 = Qt::AutoConnection;
      break;
    case 1:
      arg34 = Qt::DirectConnection;
      break;
    case 2:
      arg34 = Qt::QueuedConnection;
      break;
    case 3:
      arg34 = Qt::AutoCompatConnection;
      break;
    case 4:
      arg34 = Qt::BlockingQueuedConnection;
      break;
    case 5:
      arg34 = Qt::UniqueConnection;
      break;
    default:
      Perl_croak(aTHX_ "wrong enum value for type Qt::ConnectionType passed in");
    }
...
const char * arg52 = 0;
const char * arg60 = 0;
const QObject * arg61 = 0;
const char * arg62 = 0;
const char * arg70;
const QObject * arg71 = 0;
const char * arg72 = 0;
const QObject * arg80;
const char * arg81;
const QObject * arg82;
...
PPCODE:
    ...
    case 1:
      {
        bool ret = THIS->disconnect(arg60, arg61, arg62);
    ST(0) = sv_newmortal();
    ST(0) = boolSV(ret);
    XSRETURN(1);
        break;
    ...
    if (sv_derived_from(ST(3), "Qt::Core::QObject")) {
        arg82 = reinterpret_cast<QObject *>(SvIV((SV*)SvRV(ST(3))));
    }
    else
        Perl_croak(aTHX_ "arg82 is not of type Qt::Core::QObject");
    arg83 = (const char *)SvPV_nolen(ST(4));
    bool ret = THIS->disconnect(arg80, arg81, arg82, arg83);
    ST(0) = sv_newmortal();
    ST(0) = boolSV(ret);
    XSRETURN(1);
        break;
