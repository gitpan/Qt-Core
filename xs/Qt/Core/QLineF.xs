...
PPCODE:
    ...
    case 2:
      {
        ...
        Perl_croak(aTHX_ "arg10 is not of type Qt::Core::QLine");
    ...
    if (sv_isa(ST(2), "Qt::Core::QPointF")) {
        arg21 = reinterpret_cast<QPointF *>(SvIV((SV*)SvRV(ST(2))));
    }
    else
        Perl_croak(aTHX_ "arg21 is not of type Qt::Core::QPointF");
...
PPCODE:
    if (sv_isa(ST(1), "Qt::Core::QLineF")) {
        ...
        Perl_croak(aTHX_ "arg00 is not of type Qt::Core::QLineF");
